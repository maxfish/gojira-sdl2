...
namespace SpriterEngine {
    ...
    JSONSpriterFileElementWrapper::newAttributeWrapperFromFirstAttribute(const std::string &attributeName) {
        if (!isValid()) {
    ...
    JSONSpriterFileElementWrapper::newElementWrapperFromFirstElement(const std::string &elementName) {
        if (!isValid()) {
